...
filButton.addEventListener('click', function (event) {
  ...
  var a = document.getElementById('exh1-id');

  var species_exhibit = e.options[e.selectedIndex].text;
  var animal_exhibit = a.options[a.selectedIndex].text;
  ...
  if (name == "") {
    ...
    th1.innerHTML = "Animal Name"
    tr1.appendChild(th1);

    var th1 = document.createElement('th');
    th1.classList.add('col');
    th1.innerHTML = "Exhibit Animal is in"
    tr1.appendChild(th1);

    var th1 = document.createElement('th');
    th1.classList.add('col');
    th1.innerHTML = "Species Animal is"
    tr1.appendChild(th1);
