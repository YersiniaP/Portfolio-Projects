...
var filButton = document.getElementById('new-add');
  ...
  document.addEventListener('click', function(e) {
      ...
      if (target.className == 'closex') {
        ...
        document.getElementById('ok-close1').setAttribute("onClick", "deleteZookeeper(" + one + ")");
        ...
        document.getElementById('spe-ex-edit').value = three;
        document.getElementById('ani-exh-edit').value = four;

        var xbox = document.getElementById('close-box2');

        var one = target.parentNode.parentNode.childNodes[1].innerHTML;
        document.getElementById('ok-close2').setAttribute("onClick", "editzookeeper(" + one + ")");
